...
class AutoClockOutEmployeeController extends Controller
{
    ...
    public function __invoke(Request $request, TimeClockService $timeClock): JsonResponse
    {
        $validated = $request->validate([
            ...
            'trigger' => ['nullable', 'string', 'in:left_geofence'],
        ]);
        ...
        try {
            $result = $timeClock->autoClockOutOnGeofenceExit($employee, [
        ...
        return response()->json([
            'message' => 'Automatically clocked out because you left your assigned work site.',
