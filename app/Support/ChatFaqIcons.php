...
/**
 * Feather-compatible icons for Chat Help FAQs (admin previews + mobile Feather names).
 */
final class ChatFaqIcons
{
    /**
     * @return list<string>
     */
    ...
    public static function svgMarkup(string $name): string
    {
        $entry = self::catalog()[$name] ?? self::catalog()['help-circle'];
