...
<div class="relative" data-account-menu>
    ...
    >
        ...
        <div class="border-t border-brand-border/80 p-2">
            @if (! empty($user->company_id) && Route::has('admin.terms.edit'))
                <a
                    href="{{ route('admin.terms.edit') }}"
                    role="menuitem"
                    class="mb-1 flex w-full items-center justify-between gap-3 rounded-xl px-3 py-2.5 text-left text-sm font-semibold text-brand-text transition hover:bg-brand-surface"
                >
                    <span class="inline-flex items-center gap-2.5">
                        <span class="inline-flex size-8 items-center justify-center rounded-lg bg-brand-primary/[0.08] text-brand-primary">
