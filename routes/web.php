...
Route::middleware('auth:portal')->group(function (): void {
    ...
    Route::get('/admin/workforce/job-titles/{jobTitle}', [AdminWorkforceController::class, 'showJobTitle'])->whereNumber('jobTitle')->name('admin.workforce.job-titles.show');
    ...
    Route::post('/admin/workforce/job-titles/{jobTitle}', [AdminWorkforceController::class, 'updateJobTitle'])->whereNumber('jobTitle')->name('admin.workforce.job-titles.update');
    Route::post('/admin/workforce/job-titles/{jobTitle}/rates', [AdminWorkforceController::class, 'updateJobTitleRates'])->whereNumber('jobTitle')->name('admin.workforce.job-titles.rates.update');
    Route::post('/admin/workforce/job-titles/{jobTitle}/employees', [AdminWorkforceController::class, 'assignJobTitleEmployees'])->whereNumber('jobTitle')->name('admin.workforce.job-titles.employees.assign');
    Route::post('/admin/workforce/job-titles/{jobTitle}/archive', [AdminWorkforceController::class, 'archiveJobTitle'])->whereNumber('jobTitle')->name('admin.workforce.job-titles.archive');
    Route::post('/admin/workforce/job-titles/{jobTitle}/restore', [AdminWorkforceController::class, 'restoreJobTitle'])->whereNumber('jobTitle')->name('admin.workforce.job-titles.restore');
